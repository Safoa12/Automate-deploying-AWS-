pipeline {
    ...
    parameters {
        ...
        string(name: 'GITHUB_REPO_URL', defaultValue: 'https://github.com/Safoa12/Automate-deploying-AWS-.git', description: 'Github repository url')
        ...
        stage('Terraform Init') {
            steps {
                script {
                    ...
                    dir("${WORKSPACE}/Automate-deploying-AWS-") {
